# Generated by Django 3.1.4 on 2021-02-10 18:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, help_text='Include country prefix code. (E.g. +91 for IN)', max_length=25, null=True, validators=[django.core.validators.RegexValidator(message='Enter Valid Phone Number.', regex='^(\\+91)(\\d{10})$')], verbose_name='Phone Number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('due_date', models.DateTimeField(default=datetime.datetime(2021, 2, 17, 18, 22, 32, 573933, tzinfo=utc), help_text='By defualt date is 7 days')),
